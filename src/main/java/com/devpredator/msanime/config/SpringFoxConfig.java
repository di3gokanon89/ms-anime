 ...
 * 
 */
package com.devpredator.msanime.config;
...
public class SpringFoxConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.devpredator.msanime.controllers"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("DevPredator - Animes's API Documentation")
				.description("Defines all the endpoints of the anime's microservice")
